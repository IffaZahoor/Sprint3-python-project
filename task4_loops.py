...
#B
for counting in video_game_sales:
    
    if counting[YEAR] < 2000:
        pre_2000_count = pre_2000_count + 1
        
print(f"pre_2000_count:{pre_2000_count}")   
...
for game in video_game_sales:
    na_total = na_total + game[NA_SALES]
    jp_total = jp_total + game[JP_SALES]
...
for pub in video_game_sales:
    if pub[PUBLISHER] == 'Nintendo':
        nintendo_games.append(pub[NAME])
