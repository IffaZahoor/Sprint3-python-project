...
#C
Wii_Sports_sales = video_game_sales[0][9]
global_sales_list = []
for game in video_game_sales:
    global_sales_list.append(game[9])
total_global_sales = sum(global_sales_list)
...
20
Average global sales: 29.3305
Top_game_share: 14.10477148360921
